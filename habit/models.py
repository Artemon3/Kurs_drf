...
class Habit(models.Model):
    ...
    owner = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE,
                              verbose_name='Владелец привычки', **NULLABLE)
    ...
    nice_habit_bool = models.BooleanField(default=False,
                                          verbose_name='Признак полезной привычки')
    nice_habit = models.ForeignKey('self', on_delete=models.SET_NULL, max_length=100,
